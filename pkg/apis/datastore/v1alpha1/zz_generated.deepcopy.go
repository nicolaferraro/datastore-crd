...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataStorePodTerminationStatus) DeepCopyInto(out *DataStorePodTerminationStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataStorePodTerminationStatus.
func (in *DataStorePodTerminationStatus) DeepCopy() *DataStorePodTerminationStatus {
	if in == nil {
		return nil
	}
	out := new(DataStorePodTerminationStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DataStoreStatus) DeepCopyInto(out *DataStoreStatus) {
	*out = *in
	if in.PodTerminationStatuses != nil {
		in, out := &in.PodTerminationStatuses, &out.PodTerminationStatuses
		*out = make([]DataStorePodTerminationStatus, len(*in))
		copy(*out, *in)
	}
	return
}
