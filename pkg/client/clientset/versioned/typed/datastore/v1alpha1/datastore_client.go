...
import (
	...
	"nicolaferraro.me/datastore-crd/pkg/client/clientset/versioned/scheme"
)
...
// DatastoreV1alpha1Client is used to interact with features provided by the datastore.nicolaferraro.me group.
type DatastoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DatastoreV1alpha1Client) DataStores(namespace string) DataStoreInterface {
